...
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the interface name "IBRMWrite" in both code and config file together.
    [ServiceContract]
    public interface IBRMWrite
    {
        ...
        [OperationContract]
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "execute/{collection}/{procedure}")]
        Stream GET_Execute(string collection, string procedure);

        [OperationContract]
        [WebInvoke(Method = "POST", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Bare, UriTemplate = "execute/{collection}/{procedure}")]
        Stream POST_Execute(string collection, string procedure);
